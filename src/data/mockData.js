// Catalogue de 100 biens pour Genau International Furniture Project
...
export const MOCK_USERS_LIST = [
  ...
  { id: 'u3', name: 'Aubry Admin', email: 'admin@genau-ifp.com', role: 'admin', status: 'Actif', joinDate: '01/01/2026' }
];
