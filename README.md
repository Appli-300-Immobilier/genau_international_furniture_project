# Genau International Furniture Project - Plateforme Immobilière Premium

Bienvenue sur le dépôt du code source de l'application web **Genau International Furniture Project**. Ce projet est une solution complète (Site Vitrine + Catalogue de Biens + Administration) développée avec des technologies modernes pour le secteur de l'immobilier en Côte d'Ivoire.
...
* **Contact :** +225 22 41 43
* **Email :** contact@genauinternationalfurnitureproject.cm
* **Social :** [Facebook](https://facebook.com) | [WhatsApp](https://wa.me/237225224143)
